//credit to Christian Heilmann
//Website Blog: https://www.smashingmagazine.com/2010/10/local-storage-and-how-to-use-it/
//information used from the website has been adpated and changed based on my own need!
...
(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "products"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalCurrency = "GDP"; // PayPal's currency code
